...
* [Getting started](#getting-started)
   ...
   * [Getting a solver for linear optimization](#getting-a-solver-for-linear-optimization)
   * [Installing the backend of the web application](#installing-the-backend-of-the-web-application)
   * [Getting Nodejs](#getting-nodejs)
